...
public class MenuPrincipal extends javax.swing.JFrame {
    ...
    private void jMenuItem4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem4ActionPerformed
        Consulta_departamento abrir = new Consulta_departamento();
        abrir.setVisible(true);
    ...
    private void jMenuItem5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem5ActionPerformed
        Consulta_puestos abrir = new Consulta_puestos();
        abrir.setVisible(true);
    ...
    private void jMenuItem10MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jMenuItem10MouseClicked
        Consulta_fechaIng abrir = new Consulta_fechaIng();
        abrir.setVisible(true);
    ...
    private void jMenuItem9MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jMenuItem9MouseClicked
        Consulta_EmPuestos abrir = new Consulta_EmPuestos();
        abrir.setVisible(true);
